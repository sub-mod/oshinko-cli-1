...
##scale os::cmd::expect_success_and_text "cat ${MASTER_CONFIG_DIR}/master-config.yaml" 'disabledFeatures: null'
...
#VERBOSE=true os::cmd::expect_failure "_output/oshinko-cli get abc --token=`oc whoami -t` -o json"
#
#os::cmd::expect_success "oc project default/127-0-0-1:28443/system:admin"
